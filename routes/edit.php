                ...
                <div class="mainl">
                    <div class="list-item">
                        <a href="admin-page.php">
                            <img src="../public/img/dashboard-icon.svg" alt="" class="icon">
                    ...
                    <div class="list-item">
                        <a href="tambah.php">
                            <img src="../public/img/tambah-icon.svg" alt="" class="icon">
                            <span class="description">Tambah</span>
                        </a>
                    </div>
                    <div class="list-item">
                        <a class="active" href="edit.php">
                            <img src="../public/img/edit-icon.svg" alt="" class="icon">
                            <span class="description">Edit</span>
                        </a>
                    </div>
                    <div class="list-item">
                        <a href="upload.php">
                            <img src="../public/img/foto-icon.svg" alt="" class="icon">
                    ...
                    <div class="list-item">
                        <a href="../app/logout/action-logout.php">
                            <img src="../public/img/logout-icon.svg" alt="" class="icon">
                ...
                <tbody>
                    <?php
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo '<td>';
                                echo "<a href='../app/edit/action-edit.php?title=" . $row['title'] . "'><button class=b1><img src=../public/img/edit.svg width=20 height=20 /></button></a>";
                                echo '</td>';
                                echo '<td>';
                                echo "<a href='../app/hapus/action-hapus.php?title=" . $row['title'] . "'><button class=b2><img src=../public/img/hapus.svg width=20 height=20 /></button></a>";
                                echo '</td>';
                                echo '</tr>';
                            }
                            mysqli_close($db);
